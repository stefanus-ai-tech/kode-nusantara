    ...
    <main className="min-h-screen py-8 px-4 bg-gray-50 flex items-center justify-center">
      <div className="bg-white shadow-md rounded-lg max-w-lg w-full p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-xl font-bold">{profile?.full_name ?? profile?.username ?? user.email}</h2>
        ...
        <div className="mb-6">
          ...
          <div className="mb-2">
            ...
            {profile?.website ? (
              <a href={profile.website} className="text-blue-600 underline" target="_blank" rel="noopener">
                {profile.website}
              </a>
            ) : (
              "-"
